#!/usr/bin/env bash
#SBATCH --job-name=pc_sup_rotation
...
#SBATCH --array=0-11%3
#SBATCH --output=slurm_pointcloud_supervised_rotation_%A_%a.out
#SBATCH --error=slurm_pointcloud_supervised_rotation_%A_%a.err
